...
\end{minipage}
\vfill
{\small Data courtesy of the Zwicky Transient Facility, the ZTF Bright Transient Survey,
and the ALeRCE broker.\par}
\end{titlepage}
...
The prediction registered before any data was touched was that signatures should gain most
where sampling is irregular. Taken alone they do not beat the incumbent, so the strong form
of the claim fails. What survives is weaker and more interesting: signatures carry
information the hand-crafted features do not have. Not a better representation --- a
different one.
